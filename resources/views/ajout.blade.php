              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input type="text" id="simpleinput" class="form-control" name="titre">
                  </div>
                  <div class="form-group mb-3">
                    <label for="example-email">Description</label>
                    <input type="text" id="simpleinput" class="form-control" name="descri">
                  </div>
                  ...
                  <div class="form-group mb-3">
                    <div class="card shadow">
                      <div class="card-body">
                        ...
                        <textarea id="editor" name="contenue"> </textarea>
                      </div>
                    </div>
                  </div>
                  <div class="form-group mb-3">
                    <input type="submit" value="Ajouter" class="btn mb-2 btn-success" />
                  </div>
                  </form>
                </div> <!-- /.col -->
